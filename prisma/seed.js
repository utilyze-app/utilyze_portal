...
async function main() {
    ...
    await prisma.bill.upsert({
        ...
        create: {
            ...
            amount: 112.50,
            status: 'PAID',
            description: 'Water Bill - Sep 2025',
            issuedDate: new Date('2025-09-01'),
            dueDate: new Date('2025-09-28'),
        },
    });

    // Add a payment transaction for the paid water bill
    await prisma.paymentTransaction.upsert({
        where: { id: 'john-water-payment-1' },
        update: {},
        create: {
            id: 'john-water-payment-1',
            billId: 'john-water-bill-1',
            status: 'CRYPTO_SETTLED',
            paymentMethod: 'PLAID_BANK',
            amount: 112.50,
            cryptoTxHash: '0x1234567890abcdef1234567890abcdef12345678',
        },
    });
    ...
    await prisma.bill.upsert({
        ...
        create: {
            ...
            amount: 98.75,
            status: 'UNPAID',
            description: 'Water Bill - Oct 2025',
            issuedDate: new Date('2025-09-25'),
